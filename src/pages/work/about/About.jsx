    ...
    <>
       ...
       <div className="container flex justify-center items-center flex-col gap-7 p-6 mt-[250px] ">
         ...
         <div className="max-w-[402px] h-5 flex flex-row gap-9 justify-center ">
            <img src="../../public/images/left.png" alt="picture"  className='opacity-60 dark:invert dark:brightness-200'/>
            ...
            <img src="../../public/images/right.png" alt="picture" className='opacity-60 dark:invert dark:brightness-200' />
         </div>
       </div>
       <div className="container flex justify-center">
           <img src="../../public/images/image742.png" alt="picture" className='inline-block w-full h-[300px] sm:h-[500px]' />
       </div>
       ...
       <div className="container flex flex-col gap-6 sm:flex-row justify-center items-center mt-20 sm:mt-44 ">
          <img src="../../public/images/7263.png" alt="comment" className=' w-[200px] h-[200px] sm:w-[250px] sm:h-[250px] md:w-[300px] md:h-[300px] lg:w-[350px] lg:h-[300px]  ' />
          <img src="../../public/images/9262.png" alt="comment" className=' w-[200px] h-[200px] sm:w-[250px] sm:h-[250px] md:w-[300px] md:h-[300px] lg:w-[350px] lg:h-[300px] ' />
       </div>

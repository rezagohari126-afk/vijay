...
export default function footer() {
  ...
  <div className="container relative m-10 flex flex-col justify-end items-end w-full gap-[50px]">
    ...
    <div className="relative flex flex-row items-center justify-center gap-3 h-4 mx-auto">
      <img
        src="/images/left.png"
        alt="footerImage"
        className="w-full sm:w-[147px] dark:invert dark:brightness-200 h-3.5 absolute left-[-143px] sm:right-36"
      />
      <span className="opacity-40 font-Medium text-[12px] dark:invert dark:brightness-200">
        stay hungry, stay foolish
      </span>
      <img
        src="/images/right.png"
        alt="footerImage"
        className="w-full sm:w-[147px] h-3.5 dark:invert dark:brightness-200 absolute right-[-143px] sm:left-36"
      />
    </div>
  ...
  {/* اصلاح شده */}
  <div className="absolute bottom-4 left-1/2 -z-10 w-full sm:w-[605px] -translate-x-1/2 h-20 bg-linear-to-r from-cyan-400 via-fuchsia-400 to-yellow-400 opacity-100 rounded-[50px] blur-[80px]"></div>
</footer>
